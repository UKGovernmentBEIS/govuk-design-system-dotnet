...
{
    /// <summary>
    /// Abstract base class for all attributes that hold localisable data binding error text
    /// </summary>
    public class GovUkDataBindingLocalisableErrorTextAttribute : GovUkDataBindingErrorTextAttribute
    {
